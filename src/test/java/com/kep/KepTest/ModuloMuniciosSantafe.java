...
public class ModuloMuniciosSantafe {
...
public static WebDriver driver;
	...
	public void test1(){	
		...
		WebElement municipio = driver.findElement(By.cssSelector("#navbarSupportedContent > ul > li:nth-child(7) > a"));
		municipio.click();
	...
	public void test2(){	
		...
		WebElement municipio = driver.findElement(By.xpath("/html/body/div[3]/div/div[2]/div/a"));
		municipio.click();
