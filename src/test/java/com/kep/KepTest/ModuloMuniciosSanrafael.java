...
public class ModuloMuniciosSanrafael {
...
public static WebDriver driver;
	...
	public void test1(){	
		...
		WebElement municipio = driver.findElement(By.cssSelector("#navbarSupportedContent > ul > li:nth-child(6) > a"));
		municipio.click();
	...
	public void test2(){	
		...
		WebElement municipio = driver.findElement(By.xpath("/html/body/div[3]/div/div[1]/div/a"));
		municipio.click();
