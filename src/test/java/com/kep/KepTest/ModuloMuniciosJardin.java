...
public class ModuloMuniciosJardin {
...
public static WebDriver driver;
	...
	public void test1(){	
		...
		WebElement municipio = driver.findElement(By.cssSelector("#navbarSupportedContent > ul > li:nth-child(4) > a"));
		municipio.click();
	...
	public void test2(){	
		...
		WebElement municipio = driver.findElement(By.xpath("/html/body/div[2]/div/div[3]/div/a"));
		municipio.click();
